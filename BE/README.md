...
FastAPI est un framework Web moderne et rapide (hautes performances) pour la création d'API avec Python 3.6+ basées sur des indices de type Python standard.
